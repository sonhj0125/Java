...
// 클래스는 필요한 부품의 설계도. 클래스는 필드(속성값)와 메소드(행위)로 이루어져 있다. -> 필요한 속성 및 기능만 뽑아내는 것 : 추상화
...
public class Main_01 {
	...
	String pwd;
	String name;
	// String email = "몰라"; 초기화한 것.  // 변수에 값을 넣어준 것 = 초기화
	String email;
	...
	/* 
       ...
       문자형인 데이터타입(char)은 자동적으로 ' '(공백)으로 초기화가 되고,
       String 을 포함한 클래스 타입은 자동적으로 null 로 초기화 된다.
	...
	*/
	...
	void info_print() {
		...
		String address = "서울시 마포구";    // 지역변수는 반드시 초기화!
