...
public class Member_main {
	...
	public static void main(String[] args) {
		...
		// 1명의 새로운 회원이 필요하다.
		Member lssMbr = new Member();  // Member 클래스파일을 읽어다가 메모리에 로딩시키겠다는 말이다.
		...
		// 또, 1명의 새로운 회원이 필요하다.
		Member eom_mbr = new Member();  // Member 클래스파일을 읽어다가 메모리에 로딩시키겠다는 말이다.
		                                // Member 클래스 인스턴스(== 객체)화 했다라고 부른다.
	 ...
	 //	lssMbr.address = "서울시 강남구"; 이렇게 사용해도 되지만, static 변수는 아래와 같이 클래스명.변수명으로 사용할 것을 권장함.
		Member.address = "서울시 강남구"; // Member 클래스에 주어진 모든 인스턴스는 공유한다.
